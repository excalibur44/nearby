<?php
$message    = (isset($_GET['message']))?$_GET['message']:"操作成功";
...
<body>
  <div class="container" style="margin:0 25px; padding:15px 22px 44px;">
    <div class="row">
      <div class="col-xs-12" style="margin-top:40px;">
        <img src="img/success.png" class="img-responsive" alt="success!" style="width:120px; margin:0px auto;">
      </div>
  ...
  <footer class="container-fluid">
    <div class="row">
      <div class="col-xs-12">
        <p style="font-size:14px; text-align:center; color:#999999;"></p>
      </div>
    </div>
  </footer>
</body>
